...
#   config.warnings = true
  ...
  config.filter_run_when_matching :focus if config.respond_to? :filter_run_when_matching   # newer form 

## preparing for RSpec 4 (will be default in RSpec 4
  
  config.expect_with :rspec do |expectations|
    expectations.include_chain_clauses_in_custom_matcher_descriptions = true if config.respond_to? :include_chain_clauses_in_custom_matcher_descriptions  
  end
